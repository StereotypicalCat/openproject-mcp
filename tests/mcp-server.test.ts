...
describe("MCP Server Factory", () => {
  test("creates server and lists all 19 tools via InMemoryTransport", async () => {
    const config = {
    ...
    expect(toolsResult.tools).toHaveLength(19);
    ...
    expect(names).toContain("openproject_search_work_packages");
